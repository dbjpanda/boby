 ...
 */
class ProjectEditForm extends EntityForm {
  ...
  private function job_fields(){
    ...
    $project = $this->entity;
      ...
      $job['job_name'] = array(
        '#type' => 'textfield',
        '#title' => $this->t('Name'),
        '#default_value' => $project->job_name(),
      );
      ...
      $job['job_train_steps'] = array(
        ...
        '#default_value' => $project->job_train_steps(),
      );
      $job['job_output_dir'] = array(
        '#type' => 'textfield',
        '#title' => $this->t('Output Directory'),
        '#default_value' => $project->job_output_dir(),
      );
      $job['job_region'] = array(
        ...
        '#title' => $this->t('Region'),
        '#default_value' => $project->job_region(),
      );
      ...
      $job['job_scale_tier'] = array(
        ...
        '#default_value' => $project->job_scale_tier(),
      );
    ...
    private function model_fields(){
      ...
      $form['model_name'] = array(
        ...
        '#default_value' => $project->model_name(),
      );

      $form['model_description'] = array(
        '#type' => 'textarea',
        '#title' => $this->t('Model Description'),
        '#default_value' => $project->model_description(),
      );
      ...
      $form['model_region'] = array(
        ...
        '#title' => $this->t('Region'),
        '#default_value' => $project->model_region(),
      );
      return $form;
    }
    ...
    private function version_fields(){
      ...
      $form['version_name'] = array(
        '#type' => 'textfield',
        '#title' => $this->t('Name'),
        '#default_value' => $project->version_name(),
      );

      $form['version_default'] = array(
        '#type' => 'checkbox',
        '#title' => $this->t('Make it default version?'),
        '#default_value' => $project->version_default(),
      );

      $form['version_description'] = array(
        '#type' => 'textarea',
        '#title' => $this->t('Description'),
        '#default_value' => $project->version_description(),
      );
  /**
